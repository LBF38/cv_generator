...
export default function Home() {
    ...
    useEffect(() => {
        if (containerRef.current) {
            const designer = new Designer({ domContainer: containerRef.current, template, plugins });
        }
    }, []);
